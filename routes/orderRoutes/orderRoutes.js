...
const { createOrderController, showOrderController, showSingleOrderController, deleteOrderController, updateOrderController, showAllOrderController, pendingOrderController, cancelledOrderController, confirmedOrderController, showOrdersByUserController, showRefunedOrdersByUserController, showAllPendingOrdersController, showAllDeliveredOrdersController, showAllDeletedOrdersController, showAllCancelledOrdersController, showAllTodayOrdersController } = require("../../controllers/orderController/orderController");
...
router.get('/src/cancelled/all', showAllCancelledOrdersController);
